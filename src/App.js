          ...
          <div className="max-w-4xl mx-auto relative p-3">
            ...
            <div className="flex justify-center items-center gap-x-6 mb-3">
              ...
              <div className="relative w-24 h-24">
                ...
                <div className={`absolute top-1/2 left-0 w-4 h-4 -ml-2 -mt-2 transform rotate-45 border-2 border-white ${bases.third ? 'bg-yellow-400' : 'bg-gray-700'}`}></div>
                <div className={`absolute top-0 left-1/2 w-4 h-4 -ml-2 -mt-2 transform rotate-45 border-2 border-white ${bases.second ? 'bg-yellow-400' : 'bg-gray-700'}`}></div>
                <div className={`absolute top-1/2 right-0 w-4 h-4 -mr-2 -mt-2 transform rotate-45 border-2 border-white ${bases.first ? 'bg-yellow-400' : 'bg-gray-700'}`}></div>
                <div className="absolute bottom-0 left-1/2 w-4 h-4 -ml-2 -mb-2 transform rotate-45 border-2 border-white bg-red-600"></div>
              </div>
            </div>
            <div>
              {/* 表示切替タブ */}
